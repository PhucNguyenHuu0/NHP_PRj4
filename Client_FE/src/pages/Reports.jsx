            ...
            <tbody>
              {salesData.map((sale, index) => (
                <tr key={index} className="text-center">
                  <td className="border px-4 py-2">{sale.nhp_date}</td>
                  <td className="border px-4 py-2">{sale.nhp_total_revenue?.toLocaleString()}</td>
                  <td className="border px-4 py-2">{sale.nhp_order_count}</td>
                </tr>
              ))}
            </tbody>
          </table>
